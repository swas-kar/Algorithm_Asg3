...
const uint64_t numVertices = 4847571; //vertex numbering goes from 0 to 4847570
const uint64_t numEdges = 68993773;   //umber of lines in dataset, will be inly used to display progress bar'
